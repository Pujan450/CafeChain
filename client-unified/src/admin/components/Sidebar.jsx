...
const navItems = [
    { to: "/virat/dashboard", label: "Dashboard", Icon: Home },
    { to: "/virat/cafes/approval-queue", label: "Approvals", Icon: FileCheck },
    { to: "/virat/cafes", label: "Cafes", Icon: Building },
    { to: "/virat/users", label: "Users", Icon: Users },
    { to: "/virat/events", label: "Events", Icon: Calendar },
    { to: "/virat/contact-submissions", label: "Messages", Icon: MessageCircle },
    { to: "/virat/analytics", label: "Analytics", Icon: BarChart2 },
    { to: "/virat/promotions", label: "Promotions", Icon: Gift },
    { to: "/virat/invoices", label: "Invoices", Icon: FileText },
];
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) => {
              ...
              const isCafesLink = item.to === "/virat/cafes";
